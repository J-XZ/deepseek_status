...
enum L10nKey: String, CaseIterable, Sendable {
  ...
  case trendEstimateFiveHour = "trend.estimateFiveHour"
  case trendEstimateWeeklyBalance = "trend.estimateWeeklyBalance"
  ...
  case openCodeTrendTitle = "openCode.trendTitle"
  case openCodeTrendGo = "openCode.trendGo"
  case openCodeTrendZen = "openCode.trendZen"
  case openCodeTrendGoSummary = "openCode.trendGoSummary"
  case openCodeTrendZenSummary = "openCode.trendZenSummary"
  case openCodeTrendInsufficient = "openCode.trendInsufficient"
