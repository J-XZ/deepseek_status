...
enum L10nKey: String, CaseIterable, Sendable {
  ...
  // Grok Bot 用量
  case tabGrokBot = "tab.grokBot"
  case grokBotTitle = "grokBot.title"
  case grokBotAccount = "grokBot.account"
  case grokBotWindowTitle = "grokBot.windowTitle"
  case grokBotWindowUsedRemaining = "grokBot.windowUsedRemaining"
  case grokBotWindowUsedRemainingWithGap = "grokBot.windowUsedRemainingWithGap"
  case grokBotResetAt = "grokBot.resetAt"
  case grokBotExpectedMarker = "grokBot.expectedMarker"
  case grokBotLimitAllowed = "grokBot.limitAllowed"
  case grokBotLimitReached = "grokBot.limitReached"
  case grokBotNoIncludedLimit = "grokBot.noIncludedLimit"
  case grokBotEnterprisePooled = "grokBot.enterprisePooled"
  case grokBotTrial = "grokBot.trial"
  case grokBotLoading = "grokBot.loading"
  case grokBotEmpty = "grokBot.empty"
  case grokBotNotConfigured = "grokBot.notConfigured"
  case grokBotNotConfiguredDetail = "grokBot.notConfiguredDetail"
  case grokBotAuthInvalid = "grokBot.authInvalid"
  case grokBotLastUpdated = "grokBot.lastUpdated"
  case menuShowGrokBot = "menu.showGrokBot"
  case a11yGrokBotIcon = "a11y.grokBotIcon"
  case a11yMenuBarGrokBot = "a11y.menuBarGrokBot"
  case a11yGrokBotLegend = "a11y.grokBotLegend"
