...
/// 内存版 Cursor 历史存储，用于测试。
actor InMemoryCursorHistoryStore: CursorHistoryStoring {
  private var samples: [CursorUsageSample] = []

  func upsert(samples incoming: [CursorUsageSample], credentialID: String) async throws {
